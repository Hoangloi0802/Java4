...
<body>
						...
						<c:choose>
							<c:when test="${not empty userName}">
								...
								<li class="nav-item"><a class="nav-link active"
									aria-current="page" href="/ASS_PD10302/myFavorite">My Favorite</a></li>
	...
	<main>
		<div class="container-fluid">
			<div class="row">
				<!-- Main Video Section (The first selected video) -->
				<div class="col-7">
					<div class="card">
						<!-- Use the URL and poster of the selected video -->
						<iframe height="500px"
							src="https://www.youtube.com/embed/${selectedVideo.id}?si=Ua4hpjsqXA2hUzBB"
						...
						<div class="card-body">
							...
							<div class="d-flex flex-row-reverse gap-2">
								<a href="#" class="btn btn-primary">Share</a> <a href="javascript:void(0);" class="btn btn-primary"
										onclick="likeVideo('${selectedVideo.id}')"> <svg
							...
							<p class="card-text">
								Description: ${selectedVideo.description} <br> Views:
								${selectedVideo.views} <br> Active: ${selectedVideo.active ? 'Yes' : 'No'}
								<br>
							</p>
						</div>
					</div>
										...
										<div class="col-md-8 ">
											<div class="card-body">
												<h5 class="card-title"
													...
													${video.title}</h5>
												<p class="card-text text-truncate" style="max-width: 100%;">${video.description}</p>
											</div>
										</div>
...
<script>function likeVideo(videoId) {
    fetch('likeVideo', {
        method: 'POST',
        headers: {
	...
	<!--modal chinh sua-->
	<div class="modal fade" id="chinhsua" tabindex="-2" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <form action="UpdateProfile" method="post">
                        <div class="row">
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="username" name="username" value="${user.id != null ? user.id : ''}" readonly>
                            </div>
                            <div class="col-6 mb-3">
                                <label for="password" class="form-label">Password</label>
                                <input type="password" class="form-control" id="password" name="password" placeholder="Mật khẩu" value="${user.password != null ? user.password : ''}">
                            </div>
                            <div class="col-6 mb-3">
